...
Run this checklist against the existing pack at `agent-foundations/compliance/iso-42001-readiness/` before requesting quotes. Every "no" is a Stage 1 or Stage 2 finding waiting to happen.
...
**References:** `agent-foundations/compliance/iso-42001-readiness/` (full readiness pack), `agent-foundations/roadmap-2026/MACRO_ROADMAP.md` (program-level context).
