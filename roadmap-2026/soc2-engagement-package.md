...
- [ ] **AIMS policy signed** — versioned in `agent-foundations/compliance/soc2-evidence/policies/aims-policy-v1.md`, executive signature captured, ack-form completed by all engineers.
