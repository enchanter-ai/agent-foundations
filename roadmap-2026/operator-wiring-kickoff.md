...
All shipped artifacts live under `agent-foundations/operator-wiring-2026-05/`:
...
1. Clone the repo at the tag named in `MACRO_ROADMAP.md` § Operator-wiring. Verify `agent-foundations/operator-wiring-2026-05/` is present.
